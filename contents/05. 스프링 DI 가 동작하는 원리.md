...
## [나만의 DI Container 만들기](https://github.com/BAEKJungHo/deepdiveinreflection/tree/main/src/src/test/java/reflection/study/reflection/makemydiframework)

위 링크를 통해 코드를 확인할 수 있다. 따라서 DI 도 Relfection 을 통해 이루어진다는 것을 알 수 있다.
